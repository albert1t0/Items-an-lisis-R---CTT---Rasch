...
diff.ciencias.mat <- mean(dstr.ciencias.mat[-cmtemp.diff]) - 
  mean(-rciencias.mat$betapar[1:48][indicec_mat][-cmtemp.diff])
...
diff.letras.red <- mean(dstr.letras.red[-lrtemp.diff]) - 
  mean(-rletras.red$betapar[-lrtemp.diff])
...
diff.letras.mat <- mean(dstr.letras.mat[-lmtemp.diff]) - 
  mean(-rletras.mat$betapar[-lmtemp.diff])

```

```{r}
estructura.ciencias <- data.frame(
  medicion = c(-rciencias.mat$betapar + diff.ciencias.mat + mean(dstr.ciencias[1:48][indicec_mat][-cmtemp.diff]),
...
estructura.letras <- data.frame(
  medicion = c(-rletras.lec$betapar + diff.letras.lec + mean(dstr.letras[1:28][indicel_lec]),
               -rletras.red$betapar + diff.letras.red + mean(dstr.letras[29:56][indicel_red][-lrtemp.diff]),
               -rletras.mat$betapar + diff.letras.mat + mean(dstr.letras[57:96][indicel_mat][-lmtemp.diff])),
